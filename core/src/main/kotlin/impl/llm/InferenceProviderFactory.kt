package net.barrage.llmao.core.impl.llm
...
import net.barrage.llmao.core.impl.llm.openai.AzureAI
import net.barrage.llmao.core.impl.llm.openai.OpenAI
import net.barrage.llmao.core.impl.llm.openai.Vllm
...
class InferenceProviderFactory(config: ApplicationConfig) : ProviderFactory<InferenceProvider>() {
    ...
    private fun initAzure(config: ApplicationConfig): AzureAI {
        ...
        log.info(
            "Initializing Azure with models: {}",
