package net.barrage.llmao.core.impl.embeddings
...
import net.barrage.llmao.core.impl.embeddings.openai.AzureEmbedder
import net.barrage.llmao.core.impl.embeddings.openai.OpenAIEmbedder
import net.barrage.llmao.core.impl.embeddings.openai.VllmEmbedder
