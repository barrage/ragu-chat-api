...
interface Emitter {
   ...
   * [net.barrage.llmao.core.net.barrage.llmao.core.net.barrage.llmao.core.Plugin.configureEventSerialization].
   */
   ...
   * See [emit].
   */
  suspend fun emit(error: AppError) = emit(error, AppError.Companion.serializer())
}
