...
fun Route.whatsAppHookRoutes(whatsAppAdapter: WhatsAppAdapter) {
  post("/net/barrage/llmao/chat/whatsapp/webhook", infobipResponse()) {
...
fun Route.whatsAppRoutes(whatsAppAdapter: WhatsAppAdapter) {
  route("/net/barrage/llmao/chat/whatsapp/numbers") {
  ...
  route("/net/barrage/llmao/chat/whatsapp/chats") {
...
private fun getWhatsAppNumbersForUser(): RouteConfig.() -> Unit = {
  tags("net/barrage/llmao/chat/whatsapp/numbers")
...
private fun getWhatsAppChatForUser(): RouteConfig.() -> Unit = {
  tags("net/barrage/llmao/chat/whatsapp/chats")
