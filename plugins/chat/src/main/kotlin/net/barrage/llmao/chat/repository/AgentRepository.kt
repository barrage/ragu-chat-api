...
import net.barrage.llmao.chat.model.AgentCollection
import net.barrage.llmao.chat.model.AgentConfiguration
import net.barrage.llmao.chat.model.AgentCounts
import net.barrage.llmao.chat.model.AgentFull
import net.barrage.llmao.chat.model.AgentGroupUpdate
import net.barrage.llmao.chat.model.AgentPermission
import net.barrage.llmao.chat.model.AgentTool
import net.barrage.llmao.chat.model.AgentUpdateTools
import net.barrage.llmao.chat.model.AgentWithConfiguration
import net.barrage.llmao.chat.model.CollectionInsert
import net.barrage.llmao.chat.model.CollectionRemove
import net.barrage.llmao.chat.model.CreateAgent
import net.barrage.llmao.chat.model.SearchFiltersAdminAgents
import net.barrage.llmao.chat.model.UpdateAgent
import net.barrage.llmao.chat.model.UpdateAgentConfiguration
import net.barrage.llmao.chat.model.toAgent
import net.barrage.llmao.chat.model.toAgentCollection
import net.barrage.llmao.chat.model.toAgentConfiguration
import net.barrage.llmao.chat.model.toAgentPermission
import net.barrage.llmao.chat.model.toAgentTool
...
class AgentRepository(private val dslContext: DSLContext) {
  ...
  private fun isConfigurationDifferent(
    ...
    return requiredChanged ||
      presencePenaltyChanged ||
      titleInstructionChanged ||
      errorMessageChanged
  }
