...
open class Chats(
  ...
  val ID: TableField<ChatsRecord, UUID?> =
    createField(
      DSL.name("id"),
  ...
  val AGENT_ID: TableField<ChatsRecord, UUID?> =
  ...
  val AGENT_CONFIGURATION_ID: TableField<ChatsRecord, UUID?> =
    createField(DSL.name("agent_configuration_id"), SQLDataType.UUID.nullable(false), this, "")

  /** The column <code>public.chats.user_id</code>. */
  val USER_ID: TableField<ChatsRecord, String?> =
    createField(DSL.name("user_id"), SQLDataType.CLOB.nullable(false), this, "")

  /** The column <code>public.chats.username</code>. */
  val USERNAME: TableField<ChatsRecord, String?> =
    createField(DSL.name("username"), SQLDataType.CLOB, this, "")

  /** The column <code>public.chats.title</code>. */
  val TITLE: TableField<ChatsRecord, String?> =
    createField(DSL.name("title"), SQLDataType.CLOB, this, "")

  /** The column <code>public.chats.type</code>. */
  val TYPE: TableField<ChatsRecord, String?> =
    createField(DSL.name("type"), SQLDataType.CLOB.nullable(false), this, "")

  /** The column <code>public.chats.created_at</code>. */
  val CREATED_AT: TableField<ChatsRecord, OffsetDateTime?> =
    createField(
      DSL.name("created_at"),
  ...
  val UPDATED_AT: TableField<ChatsRecord, OffsetDateTime?> =
    createField(
      DSL.name("updated_at"),
      SQLDataType.TIMESTAMPWITHTIMEZONE(6)
        .nullable(false)
  ...
  override fun getIndexes(): List<Index> =
    listOf(CHATS_AGENT_ID_IDX, CHATS_TYPE_IDX, CHATS_USER_ID_IDX)

  override fun getPrimaryKey(): UniqueKey<ChatsRecord> = CHATS_PKEY

  override fun getReferences(): List<ForeignKey<ChatsRecord, *>> =
    listOf(CHATS__CHATS_AGENT_CONFIGURATION_ID_FKEY, CHATS__CHATS_AGENT_ID_FKEY)

  /** Get the implicit join path to the <code>public.agent_configurations</code> table. */
  fun agentConfigurations(): AgentConfigurationsPath = agentConfigurations

  val agentConfigurations: AgentConfigurationsPath by lazy {
    AgentConfigurationsPath(this, CHATS__CHATS_AGENT_CONFIGURATION_ID_FKEY, null)
  }
  ...
  override fun where(condition: Condition?): Chats =
    Chats(qualifiedName, if (aliased()) this else null, condition)
  ...
  /** Create an inline derived table from this table */
  @PlainSQL
  override fun where(@Stringly.SQL condition: String): Chats = where(DSL.condition(condition))

  /** Create an inline derived table from this table */
  @PlainSQL
  override fun where(@Stringly.SQL condition: String, vararg binds: Any?): Chats =
    where(DSL.condition(condition, *binds))

  /** Create an inline derived table from this table */
  @PlainSQL
  override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): Chats =
