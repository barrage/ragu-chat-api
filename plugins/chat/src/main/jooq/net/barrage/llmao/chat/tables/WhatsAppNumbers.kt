...
open class WhatsAppNumbers(
     ...
     */
    val ID: TableField<WhatsAppNumbersRecord, UUID?> = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuid_generate_v4()"), SQLDataType.UUID)), this, "")

    /**
     * The column <code>public.whats_app_numbers.user_id</code>.
     */
    val USER_ID: TableField<WhatsAppNumbersRecord, String?> = createField(DSL.name("user_id"), SQLDataType.CLOB.nullable(false), this, "")

    /**
     * The column <code>public.whats_app_numbers.username</code>.
     */
    val USERNAME: TableField<WhatsAppNumbersRecord, String?> = createField(DSL.name("username"), SQLDataType.CLOB.nullable(false), this, "")

    /**
     * The column <code>public.whats_app_numbers.phone_number</code>.
     */
    val PHONE_NUMBER: TableField<WhatsAppNumbersRecord, String?> = createField(DSL.name("phone_number"), SQLDataType.CLOB.nullable(false), this, "")

    /**
     * The column <code>public.whats_app_numbers.created_at</code>.
     */
    val CREATED_AT: TableField<WhatsAppNumbersRecord, OffsetDateTime?> = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")

    /**
     * The column <code>public.whats_app_numbers.updated_at</code>.
     */
    val UPDATED_AT: TableField<WhatsAppNumbersRecord, OffsetDateTime?> = createField(DSL.name("updated_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")

    private constructor(alias: Name, aliased: Table<WhatsAppNumbersRecord>?): this(alias, null, null, null, aliased, null, null)
    private constructor(alias: Name, aliased: Table<WhatsAppNumbersRecord>?, parameters: Array<Field<*>?>?): this(alias, null, null, null, aliased, parameters, null)
    private constructor(alias: Name, aliased: Table<WhatsAppNumbersRecord>?, where: Condition?): this(alias, null, null, null, aliased, null, where)
    ...
    override fun getIndexes(): List<Index> = listOf(IDX_WHATSAPP_NUMBERS_PHONE_NUMBER, IDX_WHATSAPP_NUMBERS_USER_ID)
    override fun getPrimaryKey(): UniqueKey<WhatsAppNumbersRecord> = WHATS_APP_NUMBERS_PKEY
    override fun getUniqueKeys(): List<UniqueKey<WhatsAppNumbersRecord>> = listOf(WHATS_APP_NUMBERS_PHONE_NUMBER_KEY)
     ...
     */
    override fun where(condition: Condition?): WhatsAppNumbers = WhatsAppNumbers(qualifiedName, if (aliased()) this else null, condition)

    /**
     * Create an inline derived table from this table
     */
    override fun where(conditions: Collection<Condition>): WhatsAppNumbers = where(DSL.and(conditions))
     ...
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): WhatsAppNumbers = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): WhatsAppNumbers = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): WhatsAppNumbers = where(DSL.condition(condition, *parts))
