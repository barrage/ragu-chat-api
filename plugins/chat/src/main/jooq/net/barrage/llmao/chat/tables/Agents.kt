...
open class Agents(
     ...
     */
    val ID: TableField<AgentsRecord, UUID?> = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuid_generate_v4()"), SQLDataType.UUID)), this, "")

    /**
     * The column <code>public.agents.name</code>.
     */
    val NAME: TableField<AgentsRecord, String?> = createField(DSL.name("name"), SQLDataType.CLOB.nullable(false), this, "")

    /**
     * The column <code>public.agents.description</code>.
     */
    val DESCRIPTION: TableField<AgentsRecord, String?> = createField(DSL.name("description"), SQLDataType.CLOB, this, "")

    /**
     * The column <code>public.agents.active</code>.
     */
    val ACTIVE: TableField<AgentsRecord, Boolean?> = createField(DSL.name("active"), SQLDataType.BOOLEAN.nullable(false), this, "")

    /**
     * The column <code>public.agents.active_configuration_id</code>.
     */
    val ACTIVE_CONFIGURATION_ID: TableField<AgentsRecord, UUID?> = createField(DSL.name("active_configuration_id"), SQLDataType.UUID, this, "")

    /**
     * The column <code>public.agents.language</code>.
     */
    val LANGUAGE: TableField<AgentsRecord, String?> = createField(DSL.name("language"), SQLDataType.CLOB, this, "")

    /**
     * The column <code>public.agents.avatar</code>.
     */
    val AVATAR: TableField<AgentsRecord, String?> = createField(DSL.name("avatar"), SQLDataType.CLOB, this, "")

    /**
     * The column <code>public.agents.created_at</code>.
     */
    val CREATED_AT: TableField<AgentsRecord, OffsetDateTime?> = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")

    /**
     * The column <code>public.agents.updated_at</code>.
     */
    val UPDATED_AT: TableField<AgentsRecord, OffsetDateTime?> = createField(DSL.name("updated_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "")

    private constructor(alias: Name, aliased: Table<AgentsRecord>?): this(alias, null, null, null, aliased, null, null)
    private constructor(alias: Name, aliased: Table<AgentsRecord>?, parameters: Array<Field<*>?>?): this(alias, null, null, null, aliased, parameters, null)
    private constructor(alias: Name, aliased: Table<AgentsRecord>?, where: Condition?): this(alias, null, null, null, aliased, null, where)
    ...
    constructor(path: Table<out Record>, childPath: ForeignKey<out Record, AgentsRecord>?, parentPath: InverseForeignKey<out Record, AgentsRecord>?): this(Internal.createPathAlias(path, childPath, parentPath), path, childPath, parentPath, AGENTS, null, null)

    /**
     * A subtype implementing {@link Path} for simplified path-based joins.
     */
    open class AgentsPath : Agents, Path<AgentsRecord> {
        constructor(path: Table<out Record>, childPath: ForeignKey<out Record, AgentsRecord>?, parentPath: InverseForeignKey<out Record, AgentsRecord>?): super(path, childPath, parentPath)
     ...
     * <code>public.agent_collections</code> table
     */
    fun agentCollections(): AgentCollectionsPath {
        if (!this::_agentCollections.isInitialized)
            _agentCollections = AgentCollectionsPath(this, null, AGENT_COLLECTIONS__AGENT_COLLECTIONS_AGENT_ID_FKEY.inverseKey)
    ...
    fun agentConfigurations(): AgentConfigurationsPath {
        if (!this::_agentConfigurations.isInitialized)
            _agentConfigurations = AgentConfigurationsPath(this, null, AGENT_CONFIGURATIONS__AGENT_CONFIGURATIONS_AGENT_ID_FKEY.inverseKey)
    ...
    /**
     * Get the implicit to-many join path to the
     * <code>public.agent_permissions</code> table
     */
    fun agentPermissions(): AgentPermissionsPath {
        if (!this::_agentPermissions.isInitialized)
            _agentPermissions = AgentPermissionsPath(this, null, AGENT_PERMISSIONS__AGENT_PERMISSIONS_AGENT_ID_FKEY.inverseKey)
    ...
    /**
     * Get the implicit to-many join path to the <code>public.agent_tools</code>
     * table
     */
     ...
     */
    override fun where(condition: Condition?): Agents = Agents(qualifiedName, if (aliased()) this else null, condition)
     ...
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): Agents = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): Agents = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): Agents = where(DSL.condition(condition, *parts))
