 ...
 */
@Suppress("warnings")
open class AgentConfigurationsRecord private constructor() : UpdatableRecordImpl<AgentConfigurationsRecord>(AgentConfigurations.AGENT_CONFIGURATIONS) {
     ...
     */
    constructor(id: UUID? = null, agentId: UUID, version: Int, context: String, llmProvider: String, model: String, presencePenalty: Double? = null, maxHistoryTokens: Int? = null, temperature: Double? = null, titleInstruction: String? = null, errorMessage: String? = null, createdAt: OffsetDateTime? = null, updatedAt: OffsetDateTime? = null): this() {
        this.id = id
