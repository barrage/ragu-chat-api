...
open class BonvoyageTrips(
  ...
  val ID: TableField<BonvoyageTripsRecord, UUID?> =
    createField(
      DSL.name("id"),
  ...
  val TRAVEL_ORDER_ID: TableField<BonvoyageTripsRecord, String?> =
    createField(DSL.name("travel_order_id"), SQLDataType.CLOB.nullable(false), this, "")

  /** The column <code>public.bonvoyage_trips.user_id</code>. */
  val USER_ID: TableField<BonvoyageTripsRecord, String?> =
  ...
  val USER_FULL_NAME: TableField<BonvoyageTripsRecord, String?> =
  ...
  val USER_EMAIL: TableField<BonvoyageTripsRecord, String?> =
  ...
  val START_LOCATION: TableField<BonvoyageTripsRecord, String?> =
  ...
  val TRANSPORT_TYPE: TableField<BonvoyageTripsRecord, String?> =
  ...
  val DESCRIPTION: TableField<BonvoyageTripsRecord, String?> =
  ...
  val START_DATE: TableField<BonvoyageTripsRecord, LocalDate?> =
  ...
  val END_DATE: TableField<BonvoyageTripsRecord, LocalDate?> =
  ...
  val START_REMINDER_TIME: TableField<BonvoyageTripsRecord, OffsetTime?> =
    createField(DSL.name("start_reminder_time"), SQLDataType.TIMEWITHTIMEZONE(6), this, "")

  /** The column <code>public.bonvoyage_trips.end_reminder_time</code>. */
  val END_REMINDER_TIME: TableField<BonvoyageTripsRecord, OffsetTime?> =
    createField(DSL.name("end_reminder_time"), SQLDataType.TIMEWITHTIMEZONE(6), this, "")

  /** The column <code>public.bonvoyage_trips.start_reminder_sent_at</code>. */
  val START_REMINDER_SENT_AT: TableField<BonvoyageTripsRecord, OffsetDateTime?> =
    createField(DSL.name("start_reminder_sent_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "")

  /** The column <code>public.bonvoyage_trips.end_reminder_sent_at</code>. */
  val END_REMINDER_SENT_AT: TableField<BonvoyageTripsRecord, OffsetDateTime?> =
    createField(DSL.name("end_reminder_sent_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "")

  /** The column <code>public.bonvoyage_trips.start_time</code>. */
  val START_TIME: TableField<BonvoyageTripsRecord, OffsetTime?> =
    createField(DSL.name("start_time"), SQLDataType.TIMEWITHTIMEZONE(6), this, "")

  /** The column <code>public.bonvoyage_trips.end_time</code>. */
  val END_TIME: TableField<BonvoyageTripsRecord, OffsetTime?> =
    createField(DSL.name("end_time"), SQLDataType.TIMEWITHTIMEZONE(6), this, "")

  /** The column <code>public.bonvoyage_trips.version_sent</code>. */
  val VERSION_SENT: TableField<BonvoyageTripsRecord, Int?> =
    createField(DSL.name("version_sent"), SQLDataType.INTEGER, this, "")

  /** The column <code>public.bonvoyage_trips.version</code>. */
  val VERSION: TableField<BonvoyageTripsRecord, Int?> =
    createField(
      DSL.name("version"),
  ...
  val CREATED_AT: TableField<BonvoyageTripsRecord, OffsetDateTime?> =
    createField(
      DSL.name("created_at"),
  ...
  val UPDATED_AT: TableField<BonvoyageTripsRecord, OffsetDateTime?> =
    createField(
      DSL.name("updated_at"),
      SQLDataType.TIMESTAMPWITHTIMEZONE(6)
        .nullable(false)
  ...
  val CREATED_BY_ID: TableField<BonvoyageTripsRecord, String?> =
    createField(DSL.name("created_by_id"), SQLDataType.CLOB.nullable(false), this, "")

  /** The column <code>public.bonvoyage_trips.created_by_username</code>. */
  val CREATED_BY_USERNAME: TableField<BonvoyageTripsRecord, String?> =
    createField(DSL.name("created_by_username"), SQLDataType.CLOB.nullable(false), this, "")

  /** The column <code>public.bonvoyage_trips.created_by_email</code>. */
  val CREATED_BY_EMAIL: TableField<BonvoyageTripsRecord, String?> =
    createField(DSL.name("created_by_email"), SQLDataType.CLOB.nullable(false), this, "")

  /** The column <code>public.bonvoyage_trips.vehicle_type</code>. */
  val VEHICLE_TYPE: TableField<BonvoyageTripsRecord, String?> =
    createField(DSL.name("vehicle_type"), SQLDataType.CLOB, this, "")

  /** The column <code>public.bonvoyage_trips.vehicle_registration</code>. */
  val VEHICLE_REGISTRATION: TableField<BonvoyageTripsRecord, String?> =
    createField(DSL.name("vehicle_registration"), SQLDataType.CLOB, this, "")

  /** The column <code>public.bonvoyage_trips.start_mileage</code>. */
  val START_MILEAGE: TableField<BonvoyageTripsRecord, String?> =
    createField(DSL.name("start_mileage"), SQLDataType.CLOB, this, "")

  /** The column <code>public.bonvoyage_trips.end_mileage</code>. */
  val END_MILEAGE: TableField<BonvoyageTripsRecord, String?> =
    createField(DSL.name("end_mileage"), SQLDataType.CLOB, this, "")

  /** The column <code>public.bonvoyage_trips.is_driver</code>. */
  val IS_DRIVER: TableField<BonvoyageTripsRecord, Boolean?> =
    createField(
      DSL.name("is_driver"),
  ...
  open class BonvoyageTripsPath : BonvoyageTrips, Path<BonvoyageTripsRecord> {
    ...
    override fun `as`(alias: Table<*>): BonvoyageTripsPath =
      BonvoyageTripsPath(alias.qualifiedName, this)
  }
  ...
  override fun getIndexes(): List<Index> =
    listOf(
      BONVOYAGE_TRIPS_END_DATE_IDX,
      BONVOYAGE_TRIPS_END_REMINDER_SENT_AT_IDX,
      BONVOYAGE_TRIPS_START_DATE_IDX,
      BONVOYAGE_TRIPS_START_REMINDER_SENT_AT_IDX,
      BONVOYAGE_TRIPS_TRAVEL_ORDER_ID_IDX,
      BONVOYAGE_TRIPS_USER_ID_IDX,
    )
  ...
  /**
   * Get the implicit to-many join path to the <code>public.bonvoyage_travel_expenses</code> table
   */
  fun bonvoyageTravelExpenses(): BonvoyageTravelExpensesPath {
    if (!this::_bonvoyageTravelExpenses.isInitialized)
      _bonvoyageTravelExpenses =
        BonvoyageTravelExpensesPath(
          this,
          null,
          BONVOYAGE_TRAVEL_EXPENSES__BONVOYAGE_TRAVEL_EXPENSES_TRIP_ID_FKEY.inverseKey,
        )
  ...
  /**
   * Get the implicit to-many join path to the <code>public.bonvoyage_travel_requests</code> table
   */
  fun bonvoyageTravelRequests(): BonvoyageTravelRequestsPath {
    if (!this::_bonvoyageTravelRequests.isInitialized)
      _bonvoyageTravelRequests =
        BonvoyageTravelRequestsPath(
          this,
          null,
          BONVOYAGE_TRAVEL_REQUESTS__BONVOYAGE_TRAVEL_REQUESTS_TRIP_ID_FKEY.inverseKey,
        )
  ...
  /**
   * Get the implicit to-many join path to the <code>public.bonvoyage_trip_welcome_messages</code>
   * table
   */
  fun bonvoyageTripWelcomeMessages(): BonvoyageTripWelcomeMessagesPath {
    if (!this::_bonvoyageTripWelcomeMessages.isInitialized)
      _bonvoyageTripWelcomeMessages =
        BonvoyageTripWelcomeMessagesPath(
          this,
          null,
          BONVOYAGE_TRIP_WELCOME_MESSAGES__BONVOYAGE_TRIP_WELCOME_MESSAGES_TRIP_ID_FKEY.inverseKey,
        )
  ...
  override fun where(condition: Condition?): BonvoyageTrips =
    BonvoyageTrips(qualifiedName, if (aliased()) this else null, condition)
  ...
  /** Create an inline derived table from this table */
  @PlainSQL
  override fun where(@Stringly.SQL condition: String): BonvoyageTrips =
    where(DSL.condition(condition))

  /** Create an inline derived table from this table */
  @PlainSQL
  override fun where(@Stringly.SQL condition: String, vararg binds: Any?): BonvoyageTrips =
    where(DSL.condition(condition, *binds))

  /** Create an inline derived table from this table */
  @PlainSQL
  override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): BonvoyageTrips =
