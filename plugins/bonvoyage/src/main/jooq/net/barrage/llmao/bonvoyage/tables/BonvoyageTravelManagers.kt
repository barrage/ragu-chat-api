...
open class BonvoyageTravelManagers(
  ...
  companion object {
    ...
    /** The reference instance of <code>public.bonvoyage_travel_managers</code> */
    val BONVOYAGE_TRAVEL_MANAGERS: BonvoyageTravelManagers = BonvoyageTravelManagers()
  }

  /** The class holding records for this type */
  override fun getRecordType(): Class<BonvoyageTravelManagersRecord> =
    BonvoyageTravelManagersRecord::class.java

  /** The column <code>public.bonvoyage_travel_managers.user_id</code>. */
  val USER_ID: TableField<BonvoyageTravelManagersRecord, String?> =
  ...
  val USER_FULL_NAME: TableField<BonvoyageTravelManagersRecord, String?> =
  ...
  val USER_EMAIL: TableField<BonvoyageTravelManagersRecord, String?> =
  ...
  val CREATED_AT: TableField<BonvoyageTravelManagersRecord, OffsetDateTime?> =
    createField(
      DSL.name("created_at"),
  ...
  /** Create an aliased <code>public.bonvoyage_travel_managers</code> table reference */
  ...
  constructor(
    ...
    childPath,
    parentPath,
    BONVOYAGE_TRAVEL_MANAGERS,
    null,
    null,
  )

  /** A subtype implementing {@link Path} for simplified path-based joins. */
  open class BonvoyageTravelManagersPath :
    BonvoyageTravelManagers, Path<BonvoyageTravelManagersRecord> {
    constructor(
      path: Table<out Record>,
      childPath: ForeignKey<out Record, BonvoyageTravelManagersRecord>?,
      parentPath: InverseForeignKey<out Record, BonvoyageTravelManagersRecord>?,
    ...
    override fun `as`(alias: String): BonvoyageTravelManagersPath =
      BonvoyageTravelManagersPath(DSL.name(alias), this)

    override fun `as`(alias: Name): BonvoyageTravelManagersPath =
      BonvoyageTravelManagersPath(alias, this)

    override fun `as`(alias: Table<*>): BonvoyageTravelManagersPath =
      BonvoyageTravelManagersPath(alias.qualifiedName, this)
  }

  override fun getSchema(): Schema? = if (aliased()) null else Public.PUBLIC

  override fun getIndexes(): List<Index> =
    listOf(BONVOYAGE_TRAVEL_MANAGERS_USER_EMAIL_IDX, BONVOYAGE_TRAVEL_MANAGERS_USER_ID_IDX)

  override fun getPrimaryKey(): UniqueKey<BonvoyageTravelManagersRecord> =
    BONVOYAGE_TRAVEL_MANAGERS_PKEY
  ...
  fun bonvoyageTravelManagerUserMappings(): BonvoyageTravelManagerUserMappingsPath {
    if (!this::_bonvoyageTravelManagerUserMappings.isInitialized)
      _bonvoyageTravelManagerUserMappings =
        BonvoyageTravelManagerUserMappingsPath(
          this,
          null,
  ...
  override fun `as`(alias: String): BonvoyageTravelManagers =
    BonvoyageTravelManagers(DSL.name(alias), this)

  override fun `as`(alias: Name): BonvoyageTravelManagers = BonvoyageTravelManagers(alias, this)

  override fun `as`(alias: Table<*>): BonvoyageTravelManagers =
    BonvoyageTravelManagers(alias.qualifiedName, this)

  /** Rename this table */
  override fun rename(name: String): BonvoyageTravelManagers =
    BonvoyageTravelManagers(DSL.name(name), null)

  /** Rename this table */
  override fun rename(name: Name): BonvoyageTravelManagers = BonvoyageTravelManagers(name, null)

  /** Rename this table */
  override fun rename(name: Table<*>): BonvoyageTravelManagers =
    BonvoyageTravelManagers(name.qualifiedName, null)

  /** Create an inline derived table from this table */
  override fun where(condition: Condition?): BonvoyageTravelManagers =
    BonvoyageTravelManagers(qualifiedName, if (aliased()) this else null, condition)

  /** Create an inline derived table from this table */
  override fun where(conditions: Collection<Condition>): BonvoyageTravelManagers =
    where(DSL.and(conditions))

  /** Create an inline derived table from this table */
  override fun where(vararg conditions: Condition?): BonvoyageTravelManagers =
    where(DSL.and(*conditions))

  /** Create an inline derived table from this table */
  override fun where(condition: Field<Boolean?>?): BonvoyageTravelManagers =
    where(DSL.condition(condition))

  /** Create an inline derived table from this table */
  @PlainSQL
  override fun where(condition: SQL): BonvoyageTravelManagers = where(DSL.condition(condition))

  /** Create an inline derived table from this table */
  @PlainSQL
  override fun where(@Stringly.SQL condition: String): BonvoyageTravelManagers =
    where(DSL.condition(condition))

  /** Create an inline derived table from this table */
  @PlainSQL
  override fun where(@Stringly.SQL condition: String, vararg binds: Any?): BonvoyageTravelManagers =
  ...
  ): BonvoyageTravelManagers = where(DSL.condition(condition, *parts))

  /** Create an inline derived table from this table */
  override fun whereExists(select: Select<*>): BonvoyageTravelManagers = where(DSL.exists(select))

  /** Create an inline derived table from this table */
  override fun whereNotExists(select: Select<*>): BonvoyageTravelManagers =
