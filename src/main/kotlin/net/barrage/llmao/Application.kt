...
import blob.MinioImageStorage
import database.postgres.initDatabase
...
import net.barrage.llmao.app.initializeEmbedders
import net.barrage.llmao.app.initializeInference
import net.barrage.llmao.app.initializeVectorDatabases
...
fun Application.module() {
  val providers =
    ProviderState(
      ...
      image = MinioImageStorage(environment.config),
    )

  val plugins = Plugins()
  val state = state(plugins, providers = providers, settings = TODO())
