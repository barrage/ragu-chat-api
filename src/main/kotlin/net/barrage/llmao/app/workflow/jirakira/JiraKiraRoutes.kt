...
private fun listJiraKiraWorklogAttributes(): RouteConfig.() -> Unit = {
    ...
    response {
        ...
        HttpStatusCode.InternalServerError to
                {
                    description =
                        "Internal server error occurred while listing Jira worklog attributes"
                    body<List<AppError>> {}
                }
    }
}
...
private fun upsertJiraKiraWorklogAttribute(): RouteConfig.() -> Unit = {
    ...
    response {
        ...
        HttpStatusCode.InternalServerError to
                {
                    description =
                        "Internal server error occurred while upserting Jira worklog attribute"
                    body<List<AppError>> {}
                }
    }
}
...
private fun removeJiraKiraWorklogAttribute(): RouteConfig.() -> Unit = {
    ...
    response {
        ...
        HttpStatusCode.InternalServerError to
                {
                    description =
                        "Internal server error occurred while removing Jira worklog attribute"
                    body<List<AppError>> {}
                }
    }
}
