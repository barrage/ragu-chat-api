...
class AdminAgentService(
    ...
    suspend fun getFull(id: KUUID): AgentFull =
        agentRepository.get(id) ?: throw AppError.api(
    ...
    suspend fun delete(id: KUUID) {
        val agent =
            agentRepository.getAgent(id) ?: throw AppError.api(ErrorReason.EntityDoesNotExist)
    ...
    suspend fun getAgentConfigurationWithEvaluationCounts(
        ...
        return AgentConfigurationWithEvaluationCounts(
            agentConfiguration,
            configurationMessageCounts
        )
    }
