...
//    buildClassSerialDescriptor("C2SMessage") {
...
//    val type =
//      base["type"]?.jsonPrimitive?.content ?: throw IllegalArgumentException("No type found")
//    return when (type) {
//      "chat" -> {
...
//      "system" -> {
//        val header =
//          base["payload"]?.jsonObject?.get("header")?.jsonPrimitive?.content
//            ?: throw IllegalArgumentException("No header found")
//        when (header) {
//          "open_chat" ->
//            jsonDecoder.json.decodeFromJsonElement(C2SServerMessageOpenChat.serializer(), base)
//
//          "close_chat" ->
//            jsonDecoder.json.decodeFromJsonElement(C2SServerMessageCloseChat.serializer(), base)
//
//          "stop_stream" ->
//            jsonDecoder.json.decodeFromJsonElement(C2SServerMessageStopStream.serializer(), base)
//
...
//      is C2SServerMessageOpenChat -> C2SServerMessageOpenChat.serializer().serialize(encoder,
// value)
//      is C2SServerMessageCloseChat ->
//        C2SServerMessageCloseChat.serializer().serialize(encoder, value)
//
//      is C2SServerMessageStopStream ->
//        C2SServerMessageStopStream.serializer().serialize(encoder, value)
//    }
//  }
// }
